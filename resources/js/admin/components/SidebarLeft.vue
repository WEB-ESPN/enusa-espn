<template>
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="/assets/images/nusantara.png" alt="AdminLTE Logo"
                style="heigh: 10px" >
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="/assets/images/logo admin enusa.png" class="img-circle elevation-3" alt="User Image" style="height:30px">
                </div>
                <div class="info">
